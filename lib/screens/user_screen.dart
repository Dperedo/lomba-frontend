      ...
      body: Center(
        child: Column(
          children: [
            ...
            FilterSection(),
            Divider(),
            CardUserSection(organizacion: "ususario 1",icon: Icons.person,),
            Divider(),
            CardUserSection(organizacion: "ususario 2",icon: Icons.person,),
            Divider(),
            CardUserSection(organizacion: "ususario 3",icon: Icons.person,),
            Divider(),
