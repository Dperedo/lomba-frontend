...
import '../../../login/domain/usecases/change_orga.dart';
import '../../../orgas/domain/entities/orga.dart';
import '../../../orgas/domain/usecases/get_orga.dart';
import '../../../orgas/domain/usecases/get_orgasbyuser.dart';
...
class SideDrawerBloc extends Bloc<SideDrawerEvent, SideDrawerState> {
  ...
  SideDrawerBloc(
    ...
    on<OnSideDrawerChangeOrga>((event, emit) async {
      ...
      final resultSession = await _getSession.execute();
      resultSession.fold((failure) => {}, (r) {username = r.username;});
