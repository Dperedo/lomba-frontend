...
abstract class OrgaRepository {
  ...
  Future<Either<Failure, Orga?>> existsOrga(String orgaName, String code);
  Future<Either<Failure, OrgaUser>> updateOrgaUser(
      String orgaId, String userId, OrgaUser orgaUser);
  Future<Either<Failure, List<Orga>>> getOrgasByUser(String userId);
}
