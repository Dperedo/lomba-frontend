...
class LombaAppMenu extends StatefulWidget {
  const LombaAppMenu({Key? key}) : super(key: key);
  static const appTitle = 'Lomba';
  @override
  State<LombaAppMenu> createState() => _LombaAppMenuState();
}

class _LombaAppMenuState extends State<LombaAppMenu> {
  @override
