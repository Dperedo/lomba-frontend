...
import 'package:lomba_frontend/features/roles/presentation/pages/role_page.dart';
...
void main() {
  ...
  group('lista de rolenizaciones al entrar a la página', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // assert
        verify(() => mockRoleBloc.add(const OnRoleListLoad()))
            .called(1);
  ...
  group('deshabilitar Role', () {
    ...
    testWidgets(
      ...
      verify(() => mockRoleBloc.add(OnRoleEnable(tRole2.name, false))).called(1);
    });
